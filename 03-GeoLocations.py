...
import pandas as pd
date = '1228'
df = pd.read_csv('data/NER_query' + str(date) + '.csv')
...
def display_top(col):
	...
	## Counties
gaz_counties = pd.read_table(r'data/NER/2016_Gaz_counties_national.txt')
...
##--------------------------
man_loc = pd.read_csv('data/ManualGeoLoc1228_clean.csv')
